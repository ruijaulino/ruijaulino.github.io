...
$ \begin{bmatrix} 2(\sigma_a^2 + \frac{\beta_a}{\beta_b}^2 \sigma_b^2 ) & -(\sigma_a^2 + \frac{\beta_a}{\beta_b}^2 \sigma_b^2) \\ -(\sigma_a^2 + \frac{\beta_a}{\beta_b}^2 \sigma_b^2) & 2(\sigma_a^2 + \frac{\beta_a}{\beta_b}^2 \sigma_b^2 ) \\ \end{bmatrix} $
