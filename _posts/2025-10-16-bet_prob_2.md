...
$\log p(D\|m) \approx -\frac{n}{2}\left( d\log(2\pi) + \mathbb{E}\left\[\log \|C(x)\|\right\] + \mathbb{E}\left\[ (y-\mu(x))^T C(x)^{-1} (y-\mu(x)) \right\]  \right)$

which we can write as

$\log p(D\|m) = -\frac{n}{2}\left( d\log(2\pi) + \mathbb{E}_x \left\[\log \|C(x)\|\right\] + \mathbb{E}_x \left\[ \text{tr}(C(x)^{-1} Q(x))  \right\] -2\mathbb{E}_x \left\[ \mu(x)^T C(x)^{-1} m(x) - \frac{1}{2} \mu(x)^T C(x)^{-1} \mu(x)  \right\]  \right)$
...
$\log p(D\|m) \approx -\frac{n}{2}\left( d\log(2\pi) + \mathbb{E}_x \left\[\log \|C(x)\|\right] + d -2\mathbb{E}_x \left\[ \mu(x)^T C(x)^{-1} m(x) - \frac{1}{2} \mu(x)^T C(x)^{-1} \mu(x)  \right\]  \right) =  -\frac{n}{2}\left( d\log(2\pi) + \mathbb{E}_x \left\[\log \|C(x)\|\right\] + d -2G  \right)$
