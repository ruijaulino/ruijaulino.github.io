...
The Gibbs sampler proceeds by, starting from a initial set of points $x_1^0,x_2^0,\cdots,x_k^0$, we repeat the following procedure where we sample from the conditonal univariate distribution on the most recent samples of the other variables:
