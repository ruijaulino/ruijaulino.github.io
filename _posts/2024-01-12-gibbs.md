...
$p(z\|D,\theta)=p(z_1,z_2,\cdots,z_n\|D,\theta)=p(z_1\|z_2,z_3,\cdots,z_n,D,\theta)p(z_2\|z_3,z_4,\cdots,z_n,D,\theta) \cdots p(z_n\|D,\theta)=p(z_n\|D,\theta)p(z_{n-1}\|z_n,D,\theta)\cdots p(z_1\|z_{1:n},D,\theta)$
