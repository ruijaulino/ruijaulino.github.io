...
For the analysis, consider the eigendecomposition of the second non central moment $M_{x\|z} = U(z)\Lambda(z)U(z)^T$ and the auxiliar variable $\hat{\mu(z)} = U(z)^T\mu\_{x\|z}$. Then
