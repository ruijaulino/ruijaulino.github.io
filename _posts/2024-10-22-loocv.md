...
We made an approximation assuming the conditional variance remains relatively constant when excluding points, hence the simple proportionality. By substituting $\hat{b_i}$, the performance metric can be expressed as:
