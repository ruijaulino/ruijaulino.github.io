...
amount $w_i=\frac{\mu_i}{\sigma_i^2}$ in each investment; in this case, the growth rate is $G_i=\frac{1}{2}\frac{\mu_i^2}{\sigma_i^2} = \frac{1}{2}S_i$ - this implies $S_1>S_2 \rightarrow G_1>G_2$ and so, another way to interpret a higher sharpe ratio is that the growth rate of that investment is
