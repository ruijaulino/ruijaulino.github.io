...
One way to look at this is to note that $\mu$ has dimensions of _percentage per unit of time_ (percentage changes do not have dimension of course but they are measure on some time scale) and $\sigma^2$ has 
dimensions of _percentage suared per unit of time_. Given this, Sharpe ratio has dimensions 
$T^{-\frac{1}{2}}$. 
